package com.baicai.java_question.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.baicai.java_question.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.baicai.java_question.repository.UserRepository.USERS_BY_EMAIL_CACHE);
